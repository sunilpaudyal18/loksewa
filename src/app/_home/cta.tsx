    ...
    <section className="py-20 md:py-24 border-t border-slate-800/40">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="mx-auto max-w-xl text-center rounded-2xl border border-slate-800/60 bg-slate-900 p-10"
        >
          <h2 className="text-2xl md:text-3xl font-bold tracking-tight">
            Ready to Study Smarter?
          </h2>
          <p className="mt-3 text-sm md:text-base text-slate-500 max-w-md mx-auto leading-relaxed">
