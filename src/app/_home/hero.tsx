      ...
      <div className="mx-auto w-full max-w-6xl px-6 md:px-10 lg:px-12">
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            ...
            <Link
              href="/how-it-works"
              className="inline-flex items-center gap-2 px-7 py-3 text-sm font-medium text-slate-300 border border-slate-700/60 rounded-xl hover:border-slate-600 hover:text-white transition-colors"
            >
          ...
          <motion.div
            ...
            className="mt-16 flex flex-wrap items-center justify-center gap-x-14 gap-y-5"
          >
            {stats.map((s) => (
